...
public class AddDebit
{
    ...
    @FXML
    private Label lblCno, lblPending, lblDeposited, lbldate, lblcustno, lblcustname, lblremark, lblamt, lblcustdebit;
    @FXML
    ...
    public void initialize()
    {
        if(Global.lang)
        {
            ...
            lblcustdebit.setText("Customer Debit");
            btnAdd.setText("Add");
        ...
        btnAdd.setOnAction(event -> {
            ...
            if(cid != 0 && Global.isDouble(txtAmount.getText()))
            {
                ...
                double pending1 = pending;
                double deposited1 = deposited + amt;
                ...
                resetData();
                if(Global.lang)
                    lblWarn.setText("सभासद खात्यात भरणा..!!");
                else
                    lblWarn.setText("Payment in Customer Account");
            }
            else
                if(Global.lang)
    ...
    private void setAmount()
    {
        ...
        {
            double pending1 = pending;
            double deposited1 = deposited + Double.parseDouble(txtAmount.getText());
            if(pending1 >= deposited1)
            {
                pending1 = pending1 - deposited1;
                deposited1 = 0.0;
            ...
            lblPending.setText("प्रलंबित : "+Global.round(pending1));
            lblDeposited.setText("जमा : "+Global.round(deposited1));
        }
        else
        {
